...
module.exports.resetDatabase = async function(){
    try { 
        ...
        if (result.rows.length == 0 ){
            ...
            let cardSql = `insert into "cards" ("crd_atk", "crd_cost", "crd_dsc", "crd_id", "crd_img", "crd_name", "crd_stk", "crd_tp_id") values (0, 1, 'Description', 1, NULL, 'Raidron', 1, 1);
                        insert into "cards" ("crd_atk", "crd_cost", "crd_dsc", "crd_id", "crd_img", "crd_name", "crd_stk", "crd_tp_id") values (1, 3, 'Description', 2, NULL, 'Salvagetron', 2, 1);
                        insert into "cards" ("crd_atk", "crd_cost", "crd_dsc", "crd_id", "crd_img", "crd_name", "crd_stk", "crd_tp_id") values (0, 5, 'Description', 3, NULL, 'Vicecron', 2, 1);
                        insert into "cards" ("crd_atk", "crd_cost", "crd_dsc", "crd_id", "crd_img", "crd_name", "crd_stk", "crd_tp_id") values (1, 3, 'Description', 4, NULL, 'R-no', 1, 1);
                        insert into "cards" ("crd_atk", "crd_cost", "crd_dsc", "crd_id", "crd_img", "crd_name", "crd_stk", "crd_tp_id") values (2, 5, NULL, 5, NULL, 'D-ya', 2, 1);
                        insert into "cards" ("crd_atk", "crd_cost", "crd_dsc", "crd_id", "crd_img", "crd_name", "crd_stk", "crd_tp_id") values (3, 6, NULL, 6, NULL, 'Miru', 2, 1);`
