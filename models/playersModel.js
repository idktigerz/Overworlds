...
module.exports.attackPlayer = async function (pmId, deckId) {
    try {
        ...
        let sqlUpPos = `update deck set deck_st_id = 3
                        where deck_id = $1`
...
module.exports.endTurn = async function (pmId) {
    try {
        ...
        let sqlDeck = `update deck set dk_st_id = 2 
                       where dk_st_id = 3 and dk_pm_id = $1`;
        ...
        let sqlRandCard = `Select dk_id from card 
                           where dk_st_id = 1                    
                           order by RANDOM() 
                           LIMIT 1`;
...
module.exports.playCard = async function (pmId, deckId) { 
    try {
        ...
        let sqlUpPlayerState = `update player_match set pm_state_id = 3
                         where pm_id = $1`;
